// 内置 SVG 图标（Feather / Lucide 风格，stroke 绘制），随 currentColor 着色
// 字符串 = 描边图标；{ d, fill: true } = 填充图标（品牌 logo 类）
export const icons = {
  github:
  ...
  xlogo: {
    fill: true,
    d: '<path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>',
  },
  bilibili: '<rect x="3" y="7.5" width="18" height="12.5" rx="3"/><path d="m8.5 2.5 3.5 3.5 3.5-3.5"/>',
  blog: '<path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"/><line x1="16" y1="8" x2="2" y2="22"/><line x1="17.5" y1="15" x2="9" y2="15"/>',
  ...
  smartphone:
    '<rect x="5" y="2" width="14" height="22" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/>',
  maximize:
    '<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',
  images:
    '<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="m22 13-1.296-1.296a2.41 2.41 0 0 0-3.408 0L12 17"/><circle cx="12" cy="8" r="2"/><rect width="16" height="16" x="8" y="2" rx="2"/>',
